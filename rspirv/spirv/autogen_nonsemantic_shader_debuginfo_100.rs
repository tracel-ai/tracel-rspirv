...
#[cfg(feature = "pliron")]
crate::utils::parse::parsable_flags!(DebugInfoFlags);
...
#[cfg(feature = "pliron")]
crate::utils::parse::parsable_flags!(BuildIdentifierFlags);
...
#[cfg(feature = "pliron")]
crate :: utils :: parse :: parsable_enum ! (DebugBaseTypeAttributeEncoding ; Unspecified = 0u32 , Address = 1u32 , Boolean = 2u32 , Float = 3u32 , Signed = 4u32 , SignedChar = 5u32 , Unsigned = 6u32 , UnsignedChar = 7u32 ,);
impl DebugBaseTypeAttributeEncoding {
    pub fn from_u32(n: u32) -> Option<Self> {
        Some(match n {
            0u32..=7u32 => unsafe { core::mem::transmute::<u32, DebugBaseTypeAttributeEncoding>(n) },
            _ => return None,
        })
    }
}
...
#[cfg(feature = "pliron")]
crate :: utils :: parse :: parsable_enum ! (DebugCompositeType ; Class = 0u32 , Structure = 1u32 , Union = 2u32 ,);
...
#[cfg(feature = "pliron")]
crate :: utils :: parse :: parsable_enum ! (DebugTypeQualifier ; ConstType = 0u32 , VolatileType = 1u32 , RestrictType = 2u32 , AtomicType = 3u32 ,);
...
#[cfg(feature = "pliron")]
crate :: utils :: parse :: parsable_enum ! (DebugOperation ; Deref = 0u32 , Plus = 1u32 , Minus = 2u32 , PlusUconst = 3u32 , BitPiece = 4u32 , Swap = 5u32 , Xderef = 6u32 , StackValue = 7u32 , Constu = 8u32 , Fragment = 9u32 ,);
impl DebugOperation {
    pub fn from_u32(n: u32) -> Option<Self> {
        Some(match n {
...
#[cfg(feature = "pliron")]
crate :: utils :: parse :: parsable_enum ! (DebugImportedEntity ; ImportedModule = 0u32 , ImportedDeclaration = 1u32 ,);
