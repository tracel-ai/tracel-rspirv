...
#[cfg(feature = "pliron")]
crate :: utils :: parse :: parsable_enum ! (SourceLanguage ; Unknown = 0u32 , ESSL = 1u32 , GLSL = 2u32 , OpenCL_C = 3u32 , OpenCL_CPP = 4u32 , HLSL = 5u32 , CPP_for_OpenCL = 6u32 , SYCL = 7u32 , HERO_C = 8u32 , NZSL = 9u32 , WGSL = 10u32 , Slang = 11u32 , Zig = 12u32 , Rust = 13u32 , Pred = 14u32 , ApilaJai = 15u32 ,);
impl SourceLanguage {
    pub fn from_u32(n: u32) -> Option<Self> {
        Some(match n {
            0u32..=15u32 => unsafe { core::mem::transmute::<u32, SourceLanguage>(n) },
            _ => return None,
        })
    }
}
...
impl ExecutionMode {
    pub fn from_u32(n: u32) -> Option<Self> {
        Some(match n {
            ...
            6031u32 => unsafe { core::mem::transmute::<u32, ExecutionMode>(6031u32) },
...
impl core::str::FromStr for ExecutionMode {
    ...
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        Ok(match s {
            ...
            "OpacityMicromapIdKHR" => Self::OpacityMicromapIdKHR,
...
#[cfg(feature = "pliron")]
crate :: utils :: parse :: parsable_enum ! (LinkageType ; Export = 0u32 , Import = 1u32 , LinkOnceODR = 2u32 , WeakAMD = 3u32 ,);
impl LinkageType {
    pub fn from_u32(n: u32) -> Option<Self> {
        Some(match n {
            0u32..=3u32 => unsafe { core::mem::transmute::<u32, LinkageType>(n) },
            _ => return None,
        })
    }
}
...
impl Decoration {
    pub fn from_u32(n: u32) -> Option<Self> {
        Some(match n {
            ...
            7040u32 => unsafe { core::mem::transmute::<u32, Decoration>(7040u32) },
            _ => return None,
        })
    }
}
...
impl core::str::FromStr for Decoration {
    ...
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        Ok(match s {
            ...
            "IntrinsicSAMSUNG" => Self::IntrinsicSAMSUNG,
            _ => return Err(()),
        })
    }
}
...
impl Capability {
    pub fn from_u32(n: u32) -> Option<Self> {
        Some(match n {
            ...
            4228u32..=4232u32 => unsafe { core::mem::transmute::<u32, Capability>(n) },
            ...
            4539u32 => unsafe { core::mem::transmute::<u32, Capability>(4539u32) },
            4543u32..=4544u32 => unsafe { core::mem::transmute::<u32, Capability>(n) },
            ...
            5181u32 => unsafe { core::mem::transmute::<u32, Capability>(5181u32) },
            ...
            5447u32 => unsafe { core::mem::transmute::<u32, Capability>(5447u32) },
            ...
            6032u32..=6034u32 => unsafe { core::mem::transmute::<u32, Capability>(n) },
            ...
            6257u32 => unsafe { core::mem::transmute::<u32, Capability>(6257u32) },
            6265u32 => unsafe { core::mem::transmute::<u32, Capability>(6265u32) },
            ...
            7041u32 => unsafe { core::mem::transmute::<u32, Capability>(7041u32) },
            _ => return None,
        })
    }
}
...
impl core::str::FromStr for Capability {
    ...
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        Ok(match s {
            ...
            "Float6EXT" => Self::Float6EXT,
            "Float4EXT" => Self::Float4EXT,
            "Float8UnsignedE8M0EXT" => Self::Float8UnsignedE8M0EXT,
            "MXInt8EXT" => Self::MXInt8EXT,
            "BitcastExtractEXT" => Self::BitcastExtractEXT,
            ...
            "MultipleWaitQueuesQCOM" => Self::MultipleWaitQueuesQCOM,
            "ImageGatherLinearQCOM" => Self::ImageGatherLinearQCOM,
            "ImageGatherExtendedModesQCOM" => Self::ImageGatherExtendedModesQCOM,
            ...
            "WeakLinkageAMD" => Self::WeakLinkageAMD,
            ...
            "RayTracingOpacityMicromapKHR" => Self::RayTracingOpacityMicromapKHR,
            "RayTracingOpacityMicromapEXT" => Self::RayTracingOpacityMicromapKHR,
            ...
            "CooperativeMatrixDecodeVectorNV" => Self::CooperativeMatrixDecodeVectorNV,
            ...
            "FMAKHR" => Self::FMAKHR,
            "RayTracingOpacityMicromapExecutionModeKHR" => Self::RayTracingOpacityMicromapExecutionModeKHR,
            ...
            "SplitBarrierEXT" => Self::SplitBarrierEXT,
            "SplitBarrierINTEL" => Self::SplitBarrierEXT,
            ...
            "PredicatedIOINTEL" => Self::PredicatedIOINTEL,
            "RoundedDivideSqrtINTEL" => Self::RoundedDivideSqrtINTEL,
...
#[cfg(feature = "pliron")]
crate :: utils :: parse :: parsable_enum ! (FPEncoding ; BFloat16KHR = 0u32 , Float8E4M3EXT = 4214u32 , Float8E5M2EXT = 4215u32 , Float6E2M3EXT = 4223u32 , Float6E3M2EXT = 4224u32 , Float4E2M1EXT = 4225u32 , Float8UnsignedE8M0EXT = 4226u32 , MXInt8EXT = 4227u32 ,);
impl FPEncoding {
    pub fn from_u32(n: u32) -> Option<Self> {
        Some(match n {
            0u32 => unsafe { core::mem::transmute::<u32, FPEncoding>(0u32) },
            4214u32..=4215u32 => unsafe { core::mem::transmute::<u32, FPEncoding>(n) },
            4223u32..=4227u32 => unsafe { core::mem::transmute::<u32, FPEncoding>(n) },
            _ => return None,
        })
    }
}
...
impl core::str::FromStr for FPEncoding {
    ...
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        Ok(match s {
            ...
            "Float6E2M3EXT" => Self::Float6E2M3EXT,
            "Float6E3M2EXT" => Self::Float6E3M2EXT,
            "Float4E2M1EXT" => Self::Float4E2M1EXT,
            "Float8UnsignedE8M0EXT" => Self::Float8UnsignedE8M0EXT,
            "MXInt8EXT" => Self::MXInt8EXT,
            _ => return Err(()),
        })
...
#[doc = "SPIR-V operand kind: [GatherModes]([GatherModes](https://www.khronos.org/registry/spir-v/specs/unified1/SPIRV.html#_a_id_gather_modes_a_gather_modes)#_a_id_gather_modes_a_gather_modes)"]
#[repr(u32)]
#[derive(Clone, Copy, Debug, PartialEq, Eq, PartialOrd, Ord, Hash)]
#[cfg_attr(feature = "serialize", derive(serde::Serialize))]
#[cfg_attr(feature = "deserialize", derive(serde::Deserialize))]
...
#[cfg(feature = "pliron")]
crate :: utils :: parse :: parsable_enum ! (GatherModes ; Gather4x1QCOM = 0u32 , GatherDQCOM = 1u32 , GatherH2QCOM = 2u32 , GatherV2QCOM = 3u32 ,);
impl GatherModes {
    pub fn from_u32(n: u32) -> Option<Self> {
        Some(match n {
            0u32..=3u32 => unsafe { core::mem::transmute::<u32, GatherModes>(n) },
            _ => return None,
        })
    }
}
#[allow(non_upper_case_globals)]
impl GatherModes {}
impl core::str::FromStr for GatherModes {
    type Err = ();
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        Ok(match s {
            "Gather4x1QCOM" => Self::Gather4x1QCOM,
            "GatherDQCOM" => Self::GatherDQCOM,
            "GatherH2QCOM" => Self::GatherH2QCOM,
            "GatherV2QCOM" => Self::GatherV2QCOM,
            _ => return Err(()),
        })
    }
}
...
pub enum Op {
    ...
    ControlBarrierArriveEXT = 6142u32,
    ControlBarrierWaitEXT = 6143u32,
    ...
    PredicatedLoadINTEL = 6258u32,
    PredicatedStoreINTEL = 6259u32,
...
impl Op {
    pub fn from_u32(n: u32) -> Option<Self> {
        Some(match n {
            ...
            4195u32 => unsafe { core::mem::transmute::<u32, Op>(4195u32) },
            ...
            4545u32 => unsafe { core::mem::transmute::<u32, Op>(4545u32) },
            ...
            6258u32..=6259u32 => unsafe { core::mem::transmute::<u32, Op>(n) },
...
impl Op {
    ...
    pub const TypeCooperativeVectorNV: Op = Op::TypeVectorIdEXT;
    pub const GroupNonUniformPartitionNV: Op = Op::GroupNonUniformPartitionEXT;
    ...
    pub const RayQueryGetClusterIdNV: Op = Op::RayQueryGetIntersectionClusterIdNV;
    ...
    pub const ArbitraryFloatSinCosPiINTEL: Op = Op::ArbitraryFloatSinCosPiALTERA;
    pub const ArbitraryFloatCastINTEL: Op = Op::ArbitraryFloatCastALTERA;
    pub const ArbitraryFloatCastFromIntINTEL: Op = Op::ArbitraryFloatCastFromIntALTERA;
    pub const ArbitraryFloatCastToIntINTEL: Op = Op::ArbitraryFloatCastToIntALTERA;
    pub const ArbitraryFloatAddINTEL: Op = Op::ArbitraryFloatAddALTERA;
    pub const ArbitraryFloatSubINTEL: Op = Op::ArbitraryFloatSubALTERA;
    pub const ArbitraryFloatMulINTEL: Op = Op::ArbitraryFloatMulALTERA;
    pub const ArbitraryFloatDivINTEL: Op = Op::ArbitraryFloatDivALTERA;
    pub const ArbitraryFloatGTINTEL: Op = Op::ArbitraryFloatGTALTERA;
    pub const ArbitraryFloatGEINTEL: Op = Op::ArbitraryFloatGEALTERA;
    pub const ArbitraryFloatLTINTEL: Op = Op::ArbitraryFloatLTALTERA;
    pub const ArbitraryFloatLEINTEL: Op = Op::ArbitraryFloatLEALTERA;
    pub const ArbitraryFloatEQINTEL: Op = Op::ArbitraryFloatEQALTERA;
    pub const ArbitraryFloatRecipINTEL: Op = Op::ArbitraryFloatRecipALTERA;
    pub const ArbitraryFloatRSqrtINTEL: Op = Op::ArbitraryFloatRSqrtALTERA;
    pub const ArbitraryFloatCbrtINTEL: Op = Op::ArbitraryFloatCbrtALTERA;
    pub const ArbitraryFloatHypotINTEL: Op = Op::ArbitraryFloatHypotALTERA;
    pub const ArbitraryFloatSqrtINTEL: Op = Op::ArbitraryFloatSqrtALTERA;
    pub const FixedSqrtINTEL: Op = Op::FixedSqrtALTERA;
    pub const FixedRecipINTEL: Op = Op::FixedRecipALTERA;
    pub const FixedRsqrtINTEL: Op = Op::FixedRsqrtALTERA;
    pub const FixedSinINTEL: Op = Op::FixedSinALTERA;
    pub const FixedCosINTEL: Op = Op::FixedCosALTERA;
    pub const FixedSinCosINTEL: Op = Op::FixedSinCosALTERA;
    pub const FixedSinPiINTEL: Op = Op::FixedSinPiALTERA;
    pub const FixedCosPiINTEL: Op = Op::FixedCosPiALTERA;
    pub const FixedSinCosPiINTEL: Op = Op::FixedSinCosPiALTERA;
    pub const FixedLogINTEL: Op = Op::FixedLogALTERA;
    pub const FixedExpINTEL: Op = Op::FixedExpALTERA;
    pub const PtrCastToCrossWorkgroupINTEL: Op = Op::PtrCastToCrossWorkgroupALTERA;
    pub const CrossWorkgroupCastToPtrINTEL: Op = Op::CrossWorkgroupCastToPtrALTERA;
    pub const ReadPipeBlockingINTEL: Op = Op::ReadPipeBlockingALTERA;
    pub const WritePipeBlockingINTEL: Op = Op::WritePipeBlockingALTERA;
    pub const FPGARegINTEL: Op = Op::FPGARegALTERA;
    pub const ControlBarrierArriveINTEL: Op = Op::ControlBarrierArriveEXT;
    pub const ControlBarrierWaitINTEL: Op = Op::ControlBarrierWaitEXT;
    pub const TaskSequenceCreateINTEL: Op = Op::TaskSequenceCreateALTERA;
    pub const TaskSequenceAsyncINTEL: Op = Op::TaskSequenceAsyncALTERA;
    pub const TaskSequenceGetINTEL: Op = Op::TaskSequenceGetALTERA;
    pub const TaskSequenceReleaseINTEL: Op = Op::TaskSequenceReleaseALTERA;
    pub const TypeTaskSequenceINTEL: Op = Op::TypeTaskSequenceALTERA;
}
