...
impl Assemble for dr::Operand {
    fn assemble_into(&self, result: &mut Vec<u32>) {
        match *self {
            ...
            dr::Operand::CooperativeMatrixOperands(v) => result.push(v.bits()),
            ...
            dr::Operand::LiteralBit64(v) => result.extend([v as u32, (v >> 32) as u32]),
            ...
            dr::Operand::QuantizationModes(v) => result.push(v as u32),
            dr::Operand::FPOperationMode(v) => result.push(v as u32),
            dr::Operand::OverflowModes(v) => result.push(v as u32),
            dr::Operand::PackedVectorFormat(v) => result.push(v as u32),
            dr::Operand::HostAccessQualifier(v) => result.push(v as u32),
            dr::Operand::CooperativeMatrixLayout(v) => result.push(v as u32),
            dr::Operand::CooperativeMatrixUse(v) => result.push(v as u32),
            dr::Operand::CooperativeMatrixReduce(v) => result.push(v.bits()),
            dr::Operand::TensorClampMode(v) => result.push(v as u32),
            dr::Operand::TensorAddressingOperands(v) => result.push(v.bits()),
            dr::Operand::InitializationModeQualifier(v) => result.push(v as u32),
            dr::Operand::LoadCacheControl(v) => result.push(v as u32),
            dr::Operand::StoreCacheControl(v) => result.push(v as u32),
            dr::Operand::RawAccessChainOperands(v) => result.push(v.bits()),
            dr::Operand::NamedMaximumNumberOfRegisters(v) => result.push(v as u32),
            dr::Operand::MatrixMultiplyAccumulateOperands(v) => result.push(v.bits()),
            dr::Operand::FPEncoding(v) => result.push(v as u32),
            dr::Operand::CooperativeVectorMatrixLayout(v) => result.push(v as u32),
            dr::Operand::ComponentType(v) => result.push(v as u32),
            dr::Operand::TensorOperands(v) => result.push(v.bits()),
            dr::Operand::GatherModes(v) => result.push(v as u32),
        }
    }
}
